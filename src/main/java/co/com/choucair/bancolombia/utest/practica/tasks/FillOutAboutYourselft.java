...
import co.com.choucair.bancolombia.utest.practica.userinterface.UtestFillOutAboutYourselft;
...
public class FillOutAboutYourselft implements Task {
    private UtestFillOutAboutYourselft utestFillOutAboutYourselft;
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Enter.theValue(utestData.get(0).getStrFirstName()).into(INPUT_FIRST_NAME),
                ...
                Enter.theValue(utestData.get(0).getStrEmailAddress()).into(INPUT_EMAIL_ADDRESS_),
