...
public class UtestFillOutAboutYourselft {
    ...
    public static final Target INPUT_EMAIL_ADDRESS_ = Target.the("where we write the email address").located(By.cssSelector("#email"));
    ...
    public static final Target BUTTON_NEXT_LOCATION = Target.the("button for next location").located(By.xpath("//span[contains(text(),'Next: Location')]"));
