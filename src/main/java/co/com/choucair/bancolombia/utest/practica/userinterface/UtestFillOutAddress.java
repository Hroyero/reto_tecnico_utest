...
public class UtestFillOutAddress {
    ...
    public static final Target INPUT_POSTAL = Target.the("where we select the zip code").located(By.xpath("//input[@id='zip']"));
    public static final Target INPUT_COUNTRY = Target.the("where we write the country").located(By.xpath("//body/ui-view[1]/main[1]/section[1]/div[1]/div[2]/div[1]/div[2]/div[1]/form[1]/div[1]/div[3]/div[1]/div[4]/div[2]/div[1]/div[1]/div[1]/span[1]/span[2]"));
